...
contract GameCollection is ERC1155, ERC2981, Ownable {
    ...
    constructor(uint96 _royaltyFeesInBips, string memory contract_uri) ERC1155("") {
        name = "GameCollection";
        symbol = "GCF";
    ...
    function contractURI() public view returns (string memory) {
        // return "ipfs://Qmf9p8hyx4UgfcKUm58nwuHZvP13CvBW75A2Psr6nJ1t6q";
        return _contractURI;
    }

    function setURI(uint _id, string memory _uri) external onlyOwner tokenSupply(_id) {
        tokenURI[_id] = _uri;
        emit URI(_uri, _id);
    }
